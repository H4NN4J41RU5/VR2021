<?php
	...
	function news_update($news_title, $news_content, $news_author, $news_picture_id, $news_id){
        ...
        $stmt = $conn -> prepare(" UPDATE vr21_news (vr21_news_title = ?, vr21_news_content = ?, vr21_news_author = ? , picture_id = ? WHERE news_id = ?");
        echo $conn -> error;
    ...
    function read_news(){
		...
		$conn -> set_charset("utf8");
		//valmistan ette SQL käsu
		$stmt = $conn -> prepare("SELECT vr21_news_title, vr21_news_content, vr21_news_author, vr21_news_added, vr21_news_photo_filename, vr21_news_photo_alt_text FROM vr21_news LEFT JOIN vr21_news_photo ON vr21_news_photo_news_id = vr21_news_id ORDER BY vr21_news_id DESC LIMIT 3");
		echo $conn -> error;
