...
function read_news($news_limit){
    ...
    $stmt = $conn ->prepare("SELECT vr2021_news_title, vr2021_news_content, vr2021_news_author, vr2021_news_added FROM vr2021_news ORDER BY vr2021_news_id DESC LIMIT ?");     //-Lisan SQL päringusse kuulutuse salvestus aja välja nime ja järjestuse tingimuse ja väljastavate kirjete limiidi muutuja
